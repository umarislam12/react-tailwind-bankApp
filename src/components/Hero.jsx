...
const Hero = () => (
  <section className={`flex md:flex-row flex-col ${styles.paddingY} `} id='home'>
    ...
    <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
      ...
      <h1 className=' font-poppins font-semibold text-white ss:text-[68px] text-[52px] ss:leading-[100px] leading-[75px] w-full'>Payment Method.</h1>
    ...
    <div className={`flex flex-1 ${styles.flexCenter} md:my-0 my-10 relative`}>
      ...
      <div className="absolute blue__gradient bottom-20 right-20 z-[0] w-[50%] h-[50%] top-0"/>
    </div>
